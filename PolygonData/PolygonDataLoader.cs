...
namespace PolygonData {
    public class PolygonDataLoader {
        ...
        public PolygonDataLoader(string baseUrl, string apiKey, string ticker, int multiplier, string timespan, string dateFrom, string dateTo) {
